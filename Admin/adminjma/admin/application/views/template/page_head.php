...
<head>
  ...
  <title>Admin - Jember Market Analyst</title>

  <!-- Favicons -->
  <link href="<?= base_url() ?>/assets/img/JMA.png" rel="icon">
  <link href="<?= base_url() ?>/assets/img/JMA.png" rel="apple-touch-icon">
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/lib/bootstrap-datetimepicker/datertimepicker.css" />
