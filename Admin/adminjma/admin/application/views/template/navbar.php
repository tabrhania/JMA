<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>JEMBER <span>MARKET ANALYST</span></b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <p class="green">Kamu punya 5 pesan baru</p>
              </li>
              <li>
                <a href="index.html#">
              ...
              <li>
                <a href="index.html#">Lihat semua pesan</a>
              </li>
            </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <p class="yellow">Kamu punya 7 notifikasi baru</p>
              </li>
              <li>
                <a href="index.html#">
              ...
              <li>
                <a href="index.html#">Lihat semua notifikasi</a>
              </li>
            </ul>
          </li>
