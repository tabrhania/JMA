...
<div class="container my-5 shadow-lg rounded p-3">
    ...
    1.	Dimana letak JMA berada?  
	  ...
	  <div class="card card-body">
	  	Jl. Manggar 12, Nomer No.24, Gebang Poreng, Gebang, Kec. Patrang, Kabupaten Jember, Jawa Timur 68117 
	  </div>
	</div>
    ...
    2.	Berapa keuntungan pasti yang di dapat jika kita mengikuti trader master?  
	  ...
	  <div class="card card-body">
	  	 Tidak pasti, terguntung berapa modal yang kita gunakan untuk trading dan tergantung berapa persentase keuntungan yang di dapat oleh trader master
	  </div>
	</div>
    ...
    3.	Apa saja syarat untuk menjadi trader master? 
	  ...
	  <div class="card card-body">
	  	 Trader master hanya di khususkan untuk anggota jember market analyst yang telah lama mengabdi dan mempunyai potensi 
	  </div>
	</div>
	...
	4.	 Berapa modal yang dibutuhkan untuk bergabung?
	  ...
	  <div class="card card-body">
	  	 Awal modal yang dibutuhkan untuk membuka akun JMA sebesar Rp 20.000, itu sudah termasuk biaya admin dan modal pertama trading $1
	  </div>
	</div>
</div>
<!-- isi halaman end -->
